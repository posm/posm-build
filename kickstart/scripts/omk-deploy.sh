...
deploy_omk_server() {
  ...
  wget -q -O /tmp/pyxform.tar.gz "https://github.com/spatialdev/pyxform/archive/e486b54d34d299d54049923e03ca5a6a1169af40.tar.gz"
  tar -zxf /tmp/pyxform.tar.gz -C "$dst/OpenMapKitServer/api/odk/pyxform" --strip=1

  # fetch iD submodule
  wget -q -O /tmp/omk-id.tar.gz "https://github.com/AmericanRedCross/iD/archive/omk.tar.gz"
  tar -zxf /tmp/omk-id.tar.gz -C "$dst/OpenMapKitServer/pages/id" --strip=1
