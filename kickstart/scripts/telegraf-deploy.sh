...
deploy_telegraf_ubuntu() {
  ...
  wget -q -N -P "${BOOTSTRAP_HOME}/sources" https://dl.influxdata.com/telegraf/releases/telegraf_1.7.1-1_amd64.deb
  dpkg -i "${BOOTSTRAP_HOME}/sources/telegraf_1.7.1-1_amd64.deb"
